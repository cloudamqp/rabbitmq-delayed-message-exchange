...
-define(TABLE_NAME, rabbit_delayed_message_mnesia:append_to_atom(rabbit_delayed_message, node())).
-define(INDEX_TABLE_NAME, rabbit_delayed_message_mnesia:append_to_atom(?TABLE_NAME, "_index")).
